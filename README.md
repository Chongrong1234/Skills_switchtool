...
[![Version](https://img.shields.io/badge/version-1.4.7-blue.svg)](https://github.com/Chongrong1234/Skills_switchtool/releases)
...
所有发布版本都在 [GitHub Releases](https://github.com/Chongrong1234/Skills_switchtool/releases) 页面。以下命令均可直接复制粘贴;示例用最新版 **v1.4.7**,下载历史版本把版本号换掉即可(现有:`v1.4.7`、`v1.4.5`、`v1.2.0`)。
...
curl -L -o Skills.SwitchTool.AppImage \
  https://github.com/Chongrong1234/Skills_switchtool/releases/download/v1.4.7/Skills.SwitchTool-1.4.7.AppImage
...
浏览器直接下载:[Skills.SwitchTool.Setup.1.4.7.exe](https://github.com/Chongrong1234/Skills_switchtool/releases/download/v1.4.7/Skills.SwitchTool.Setup.1.4.7.exe),双击按向导安装(可选安装目录)。

或在 PowerShell 中复制粘贴:

```powershell
curl.exe -L -o Skills.SwitchTool.Setup.exe `
  "https://github.com/Chongrong1234/Skills_switchtool/releases/download/v1.4.7/Skills.SwitchTool.Setup.1.4.7.exe"
...
curl -L -o Skills.SwitchTool.dmg \
  https://github.com/Chongrong1234/Skills_switchtool/releases/download/v1.4.7/Skills.SwitchTool-1.4.7-arm64.dmg
